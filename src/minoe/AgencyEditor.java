...
/**
 * Displays a GUI for editing the agency file.
 * @author Daniel Spiteri
 */
public class AgencyEditor extends javax.swing.JInternalFrame {
    ...
    public AgencyEditor(MetaDataController controller, File agencyFile, Globals globals) {
    ...
    /**
     * Retrieves the data from the agency file and loads into the jtable.
     */
    public void loadTableModel(File dataFile){
        try {
            if(dataFile == null){
               dataFile = this.agencyFile;
            }
            List<String[]> csvData = this.mdc.getAgencyFileData(dataFile);
    ...
    public String errorCheck(Vector<Vector> dataVector, boolean offset){
        String warnings = "";
        // Don't allow blanks or duplicates
        Vector<Vector> errorCells = new Vector<Vector>();
        for (int row = 0; row < dataVector.size(); row++) {
            Vector<String> rowData = dataVector.get(row);
            Vector<Boolean> errors = new Vector<Boolean>();
            for (int col = 0; col < rowData.size(); col++) {
                String cellValue = rowData.get(col);
                errors.add(false);
                if(cellValue.isEmpty()){
                   errors.set(col, true);
                   warnings = "Blank cells found.";
                }
            }
            errorCells.add(errors);
        ...
        this.duplicateTable = errorCells;
        revalidate();
        repaint();
    ...
    /**
     * Loads the data from the agency file back into the editor.
     */
    ...
    public void showFileChooser(){
       JFileChooser chooser = new JFileChooser();
        try{
            ...
            int returnvalue = chooser.showDialog(this, "Import agency");
...
//                String warnings = this.mdc.integrityCheck(file);
    ...
    private void initComponents() {
        ...
        setMaximizable(true);
        setResizable(true);
        setTitle(org.openide.util.NbBundle.getMessage(AgencyEditor.class, "AgencyEditor.title")); // NOI18N
        setFrameIcon(new javax.swing.ImageIcon(getClass().getResource("/minoe/greenpencil.png"))); // NOI18N
        ...
        jLabel2.setText(org.openide.util.NbBundle.getMessage(AgencyEditor.class, "AgencyEditor.jLabel2.text")); // NOI18N
        ...
        addRowButton.setText(org.openide.util.NbBundle.getMessage(AgencyEditor.class, "AgencyEditor.addRowButton.text")); // NOI18N
        ...
        deleteRowButton.setFont(new java.awt.Font("Arial", 0, 11));
        deleteRowButton.setText(org.openide.util.NbBundle.getMessage(AgencyEditor.class, "AgencyEditor.deleteRowButton.text")); // NOI18N
        ...
        revertButton.setText(org.openide.util.NbBundle.getMessage(AgencyEditor.class, "AgencyEditor.revertButton.text")); // NOI18N
        ...
        jTable.getColumnModel().getColumn(0).setHeaderValue(org.openide.util.NbBundle.getMessage(AgencyEditor.class, "AgencyEditor.jTable.columnModel.title0")); // NOI18N
        jTable.getColumnModel().getColumn(1).setHeaderValue(org.openide.util.NbBundle.getMessage(AgencyEditor.class, "AgencyEditor.jTable.columnModel.title1")); // NOI18N
        jTable.getColumnModel().getColumn(2).setHeaderValue(org.openide.util.NbBundle.getMessage(AgencyEditor.class, "AgencyEditor.jTable.columnModel.title2")); // NOI18N
        jTable.getColumnModel().getColumn(3).setHeaderValue(org.openide.util.NbBundle.getMessage(AgencyEditor.class, "AgencyEditor.jTable.columnModel.title3")); // NOI18N
        ...
        errorLabel.setText(org.openide.util.NbBundle.getMessage(AgencyEditor.class, "AgencyEditor.errorLabel.text")); // NOI18N
        ...
        importButton.setText(org.openide.util.NbBundle.getMessage(AgencyEditor.class, "AgencyEditor.importButton.text")); // NOI18N
        ...
        saveButton.setText(org.openide.util.NbBundle.getMessage(AgencyEditor.class, "AgencyEditor.saveButton.text")); // NOI18N
        ...
        cancelButton.setText(org.openide.util.NbBundle.getMessage(AgencyEditor.class, "AgencyEditor.cancelButton.text")); // NOI18N
    ...
    /**
     * Save table information to agency file.
     * @param evt
     */
    private void saveButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveButtonActionPerformed
        ...
        try {
            boolean success = this.mdc.writeToAgencyFile(outData, this.agencyFile);
            if(success){
               JOptionPane.showMessageDialog(this, "agency has been saved.");
            }else{
               JOptionPane.showMessageDialog(this, "Problem saving agency.");
            }
        } catch (IOException ex) {
            JOptionPane.showMessageDialog(this, "Error saving to agency file: " + ex.toString());
        }
        try {
            // reload data into memory
            this.mdc.loadAgenciesFile(this.agencyFile);
        } catch (FileNotFoundException ex) {
            JOptionPane.showMessageDialog(this, "Could not reload the agency.  Please the restart the application to apply your changes. " + ex.toString());
        } catch (IOException ex) {
            JOptionPane.showMessageDialog(this, "Could not reload the agency.  Please the restart the application to apply your changes. " + ex.toString());
        }
        revalidate();
    ...
    /**
     * Custom table cell renderer used in the agency table.
     */
